...
import com.mrsoftware.udb.exceptions.UltraDbServicesException;
...
public class ServletBase extends HttpServlet {
    ...
    protected void writeResponse(HttpServletResponse response, String entity) {
        try {
            ...
            throw new UltraDbServicesException(e, "Error writing HTTP response!", "Entity", entity);
        }
    }
    ...
    protected String getRequestBody(HttpServletRequest request) {
        ...
        try {
            ...
            throw new UltraDbException(ex, "Exception reading HTTP request body!");
        } finally {
            try {
